...
<div className="form-check form-switch mx-3" onClick={props.toggleMode} >
  {props.mode==='light'?   <img src="https://cdn2.iconfinder.com/data/icons/user-interface-vol-2-14/48/brightness-light-up-day-mode-512.png" alt="" width={'30px'} style={{cursor: 'pointer'}}/>
:<img src={DarkMode} alt='' width={'30px'} style={{cursor: 'pointer'}}/>
}
